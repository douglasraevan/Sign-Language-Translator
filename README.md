...
Cloud Access Team have forked and reworked this application to use Custom Vision Tensorflow.js model trained on Azure Custom Vision. This rework will be delivered and presented as a demo prototype for Microsoft AI for Accessibility Hackathon competition.
